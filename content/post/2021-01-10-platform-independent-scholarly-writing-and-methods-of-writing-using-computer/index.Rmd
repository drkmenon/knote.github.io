...
+ Netlify account
+ LaTEX
+ Use `Rmd` for most cases except course and posts requiring mermaid. I those cases use `md` (Always from the file, not from new post from addins)
...
```{r}
knitr::include_url('https://www.knote.github.io/static/nmj.html#1')
```
